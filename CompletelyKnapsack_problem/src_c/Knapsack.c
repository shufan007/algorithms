...
******************************************************************** */
static void CombinationSearchCommonInit(const Knapsack_T*);
static void AllocInfoInit();
static void TraceFileInit();
static void PrintSearchedStatisticsInfo();
static void AllocateProcess();
static void AllocDownStep();
static void NextAllocationControlProcess();
static void AllocRollbackOneStep();
static void AllocRollbackToBranchRoot();
static void SearchingLogTrace();
void PrintArrayToFile(FILE*, int*, int);
static void TopListUpdate(TopList_T*);
static void HeapUpdateTop(TopList_T*, CombinStat_T*);
static void MinHeapify(TopList_T*, int);
void HeapPop(TopList_T*);
static void HeapPush(TopList_T* , CombinStat_T*);
static void SwapCombinStats(CombinStat_T* , CombinStat_T*);
...
const Knapsack_T  * knapsackPtr = NULL;
...
static void CombinationSearchCommonInit(const Knapsack_T *knapsack)
{
    g_count++; 
...
*************************************************************/
static void TopListUpdate(TopList_T* topListPtr)
{
...
static void HeapUpdateTop(TopList_T* topList, CombinStat_T* Obj)
{
...
************************************************************/
static void MinHeapify(TopList_T* topList, int current)
{
    int LeftChild;
    int RightChild;
...
static void HeapPush(TopList_T* topList, CombinStat_T* Obj)
{
    int current;
    int parent;
...
************************************************************/
static void SwapCombinStats(CombinStat_T* obj1, CombinStat_T* obj2)
{
    CombinStat_T Temp;
